...
public class userDao {
    ...
    public int Signup(String name, String password,int role) throws SQLException {
    ...
    public ArrayList<Course>getUserCourses(int id_user) throws SQLException {
        String sql="select * from courses a join course_student b on a.id=b.course_id and b.student_id=? ";
        PreparedStatement stmt=con.prepareStatement(sql);
